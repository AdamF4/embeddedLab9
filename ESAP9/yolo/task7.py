#This script is based on the examples/caffe/TineyYolo example.
#It has been modifed for use in the GEM Edge AI workshop by Joseph Lemley.
...
tiny_yolo_graph_file= "graph" #TODO: Assign this to the name of the pretrained yolo graph file.
...
def display_objects_in_gui(source_image, filtered_objects):
    ...
    for obj_index in range(len(filtered_objects)):
        ...
        cv2.rectangle(source_image,(box_left, box_top-20),(box_right,box_top), label_background_color, -1)
        cv2.putText(source_image,filtered_objects[obj_index][0] + ' : %.2f' % filtered_objects[obj_index][5], (box_left+5,box_top-7), cv2.FONT_HERSHEY_SIMPLEX, 0.5, label_text_color, 1)
